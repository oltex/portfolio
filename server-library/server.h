...
#pragma warning(suppress: 26495)
	...
	inline void start(void) noexcept {
		...
		_process_total_time = query.add_counter(L"\\Process(server-library)\\% Processor Time");
		_process_user_time = query.add_counter(L"\\Process(server-library)\\% User Time");
		_process_kernel_time = query.add_counter(L"\\Process(server-library)\\% Privileged Time");
		...
		_process_private_byte = query.add_counter(L"\\Process(server-library)\\Private Bytes");
		_process_pool_nonpaged_byte = query.add_counter(L"\\Process(server-library)\\Pool Nonpaged Bytes");
